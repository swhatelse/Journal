...
*** DONE 2015-06-12 vendredi [3/3]
    - [X] Update StarPU version :
      Update in branch steven-starpu-update and merge with steven-mpi.
      Host name récupéré est incorrect lors de l'appel à
      MSG_process_create_with_arguments(), la fonction
      starpu_mpi_world_rank() me retourne 91 donnant ->
      StarPU-MPI91-MAIN.
      - Current vesion
	#+BEGIN_EXAMPLE
	...
	- Valgrind report:
      ...
      still exitsts.
    - [X] Segfault, strcmp_sse2_unaligned:
