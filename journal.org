...
*** 2015-06-08 lundi
    - Modification de l'initialisation côté StarPU: 
...
*** DONE 2015-06-11 jeudi [1/1]
    ...
    -1 mais j'imagine que c'est le segment index du process que l'on
    veut utiliser la place. De plus j'ai déplacé l'affectation du
    segment_index pour les process SMPI dans SIMIX_process_create.
    ...
    - [X] Vérification du segment data:
      ...
      - Au switch (smpi_really_switch_data_segment):
        - Etablissement swap de segment data (mmap) 
      - A coup de gdb, les adresses sont bien corrects:
        #+BEGIN_EXAMPLE
