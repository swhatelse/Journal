...
***** Lets run untill it crashes
      ...
      #+END_EXAMPLE
***** TODO Who is responsible for? [0/1]
     - [ ]  Find where and when 1 did this
     It seems it is the pid 1.
     #+BEGIN_EXAMPLE
     #3  0x00007ffff73becab in SIMIX_simcall_handle (simcall=0x8f4cd8, value=0) at /home/steven/Programmation/TER/starpu-simgrid/src/simgrid/src/simix/popping_generated.c:189
...
*** TODO 2015-07-02 Thursday [0/1]
    - [ ] Update StarPU
*** TODO 2015-07-03 Friday [0/1]
      We calling MPI_Init for the first time I try to see if it was
      ...
      - [ ] Did we really need to modify smpi_process_initialized?
* Changes
  work in progress
** SimGrid
*** Segment data management
*** Delete shared context only one time 
