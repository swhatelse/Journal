...
\item Mécanisme de privatisation:
\alert{ségment virtuel} (mmap)
\end{itemize}
...
\begin{itemize}
\item Basé sur MSG car modèle de performance plus prohe (communications).
\end{itemize}
\end{frame}
\begin{frame}[label=sec-4-5]{StarPU SMPI}
\end{frame}
