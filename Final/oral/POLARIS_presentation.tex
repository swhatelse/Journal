...
\label{sec-6}
\begin{frame}[label=sec-6-1]{Contribution}
\begin{columns}
  \begin{column}{.6\linewidth}
\begin{itemize}
\item Modification SimGrid:
\begin{itemize}
...
\section{Validation}
\label{sec-7}
\begin{frame}[label=sec-7-1]{Validation}
\begin{itemize}
...
\section{Conclusion}
\label{sec-8}
\begin{frame}[label=sec-8-1]{Conclusion}
\begin{block}{Bilan}
\begin{itemize}
