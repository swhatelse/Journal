...
\end{itemize}
\item \alert{Problématique} : Performances difficiles à évaluer car exécution du
...
\item MPI environnement à \alert{mémoire distribuée}.
