...
dans ce dernier (DSO sur la figure\ref{fig:3}), elles restent donc
...
\caption{\label{fig:4}Emplacement en mémoire des bibliothèques}
\end{figure}
...
stage dans son équipe. Ensuite, je souhaite tout d'abord remercier
Arnaud LEGRAND, mon tuteur de stage (notre gourou) pour avoir été
aussi disponible et pour sa patience, pour avoir su me guider tout
au long de ce TER, et également pour m'avoir tellement appris. Sans
lui cette expérience n'aurait pas été possible et grâce à cela j'ai
trouvé un domaine qui me plaît particulièrement. Je souhaite
...
Thibaud BUCHS pour ces pauses cafés. 
\nocite{*}
\def\raggedright{}
