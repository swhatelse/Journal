* Intro
  ...
  un point crucial. Actuellement, la calculteur le plus puissant, est
  capable de calculer environ 33.86 Peta d'opérations flotantes par
  secondes  Mais acutellement, le coût energétique de ces  machines
  est devenue tellement élevé au cours des ces dernière années 
